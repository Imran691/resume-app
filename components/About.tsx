    ...
    <div className='flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20'>
      ...
      />
        ...
        <div className='w-full md:w-1/2 text-base md:text-lg text-center md:text-left'>
            <h2 className='text-primary-default font-bold text-2xl md:text-3xl mb-3'>{name} </h2>
            <h4 className='text-primary-default font-bold text-xl md:text-2xl mb-3'>{message}</h4>
